...
<body>
    <div id="wrapper">
        <form action="dangKy.aspx" id="form_signUp" method="post" runat="server">
            <h1 class="form-heading">Đăng ký</h1>
            <div class="form-group">
                <input type="text" class="form-input" placeholder="Email" name="txtEmail"/>
            </div>
            <div class="form-group">
                <input type="password" class="form-input" placeholder="Mật khẩu" name="txtMatKhau"/>
            </div>
            <div class="form-group">
                <input type="password" class="form-input" placeholder="Nhắc lại mật khẩu"/>
            </div>
